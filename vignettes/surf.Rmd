...
# Overview
This document provides an example of using *SURF**SURF** (Version `r packageVersion("surf")`) to integrate CLIP-seq and RNA-seq data for predicting RNA-binding protein (RBP) functions in alternative transcriptional regulation (ATR). 
...
# Preparations
To reproduce the results in this vignette, download the demo data from XXX and put them into a "data" folder under the working directory. 
