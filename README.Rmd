...
Here, `anno_file`, `rna_seq_sample`, `clip_seq_sample`, and `external_sample` are data description, and `exprMat` is a table of extra transcriptome quantification (e.g., TCGA, GTEx, ...).
