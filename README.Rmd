...
We used SURF to analyzed 104 RBP data (K562 cells, available from [ENCODE](https://www.encodeproject.org)). 
<!-- Check out the results from this [shiny](http://www.statlab.wisc.edu/shiny/surf/) app! -->

_**A detailed vignette is available [here](http://pages.stat.wisc.edu/~fanchen/surf_vignette.html).**_
